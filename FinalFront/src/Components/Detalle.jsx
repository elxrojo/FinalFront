...
import style from "../Styles/ComponentStyles/CardDetail.module.css"
    ...
    return(
        <div className={style.contenedor}>
            ...
            <div className={style.detallesPrincipales}>
                ...
                <h3>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill={theme.colorLetra} className="bi bi-globe2" viewBox="0 0 16 16">
                ...
                <h3>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill={theme.colorLetra} className="bi bi-telephone-fill" viewBox="0 0 16 16">
            ...
            <div className={style.otrosDetalles}>
                <div>
                    <p>
                ...
                <div>
                    <p>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill={theme.colorLetra} className="bi bi-geo-alt-fill" viewBox="0 0 16 16">
